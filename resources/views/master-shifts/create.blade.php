...
@section('title', 'Add Master Shift')
@section('header', 'Add Master Shift')
    ...
    <div class="card bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        <form action="{{ route('master-shifts.store') }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="time" name="start_time" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">End Time</label>
                        <input type="time" name="end_time" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    </div>
                </div>
            ...
            <div class="mt-6 flex justify-end gap-3">
                ...
                <button type="submit" class="px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">Save Shift</button>
            </div>
        </form>
    </div>
</div>
